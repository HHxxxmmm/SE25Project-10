...
public class Seat {
    ...
    private Long date1 = 0L; // 2025-07-01日期位图，最后5位表示区间占用
    
    @Column(name = "date_2", nullable = false)
    private Long date2 = 0L; // 2025-07-02日期位图，最后5位表示区间占用
    
    @Column(name = "date_3", nullable = false)
    private Long date3 = 0L; // 2025-07-03日期位图，最后5位表示区间占用
    
    @Column(name = "date_4", nullable = false)
    private Long date4 = 0L; // 2025-07-04日期位图，最后5位表示区间占用
    
    @Column(name = "date_5", nullable = false)
    private Long date5 = 0L; // 2025-07-05日期位图，最后5位表示区间占用
    
    @Column(name = "date_6", nullable = false)
    private Long date6 = 0L; // 2025-07-06日期位图，最后5位表示区间占用
    
    @Column(name = "date_7", nullable = false)
    private Long date7 = 0L; // 2025-07-07日期位图，最后5位表示区间占用
    
    @Column(name = "date_8", nullable = false)
    private Long date8 = 0L; // 2025-07-08日期位图，最后5位表示区间占用
    
    @Column(name = "date_9", nullable = false)
    private Long date9 = 0L; // 2025-07-09日期位图，最后5位表示区间占用
    
    @Column(name = "date_10", nullable = false)
    private Long date10 = 0L; // 2025-07-10日期位图，最后5位表示区间占用
} 